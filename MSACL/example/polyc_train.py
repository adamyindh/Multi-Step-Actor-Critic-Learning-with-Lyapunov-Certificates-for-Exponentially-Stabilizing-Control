...
if __name__ == "__main__":
    ...
    ################################################
    # Env, algorithm and CUDA
    parser.add_argument("--env_name", type=str, default="Pendulum", help="Environment ID")
    parser.add_argument("--algorithm", type=str, default="polyc", help="RL algorithm")
    ...
    parser.add_argument("--is_render", type=bool, default=False, help="Enable env rendering") 
    ...
    parser.add_argument("--value_hidden_activation", type=str, default="relu", help="Activation: relu/gelu/elu/selu/sigmoid/tanh")
    parser.add_argument("--value_output_activation", type=str, default="linear", help="Activation: linear/tanh")

    ################################################
    # 3. Lyapunov function parameters
    parser.add_argument(
        "--lyapunov_func_name",
        type=str,
    ...
    parser.add_argument("--lyapunov_hidden_activation", type=str, default="tanh", help="Activation: relu/gelu/elu/selu/sigmoid/tanh")
    parser.add_argument("--lyapunov_output_dim", type=int, default=256)
    parser.add_argument("--lyapunov_output_activation", type=str, default="linear", help="Activation: linear/tanh")
    parser.add_argument("--lyapunov_single_input_dim", type=bool, default=False, help="Use single sub-state as input")

    ################################################
    # 4. Policy function parameters
    parser.add_argument(
        "--policy_func_name",
        type=str,
    ...
    if policy_func_type == "MLP":
        ...
        parser.add_argument("--policy_hidden_activation", type=str, default="relu", help="Activation: relu/gelu/elu/selu/sigmoid/tanh")
    parser.add_argument("--policy_min_log_std", type=float, default=-20)
    parser.add_argument("--policy_max_log_std", type=float, default=1)

    ################################################
    # 5. RL algorithm parameters
    ...
    ################################################
    # 6. Trainer parameters
    parser.add_argument("--trainer", type=str, default="on_serial_trainer", help="Options: on_serial_trainer, off_serial_trainer")
    ...
    ################################################
    # 7. Sampler parameters
    parser.add_argument("--sampler_name", type=str, default="on_sampler", help="Options: on_sampler/off_sampler")
    parser.add_argument("--sample_interval", type=int, default=1)
    parser.add_argument("--sample_batch_size", type=int, default=1600, help="Batch size per env per sampling")
    # Validate sample batch size
    assert (
    ...
    parser.add_argument("--noise_params", type=dict, default=None, help="Action noise for exploration")
    ...
    parser.add_argument("--apprfunc_save_interval", type=int, default=50000, help="Save network interval")
    parser.add_argument("--log_save_interval", type=int, default=50000, help="Save log interval")
    ...
    print("Training data folder: {}".format(args["save_folder"]))
    trainer.train()
